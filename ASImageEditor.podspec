...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of ASImageEditor.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Avigit Saha/ASImageEditor'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Avigit Saha' => 'me@avigit.com' }
  s.source           = { :git => 'https://github.com/Avigit Saha/ASImageEditor.git', :tag => s.version.to_s }
